...
VALUES ('SIG01', 'ISBN123');
INSERT INTO copies (SIGNATURE, ISBN)
VALUES ('SIG02', 'ISBN123');
...
where USER_ID = 'USER001'
  and SIGNATURE in ('SIG01', 'SIG02', 'SIG03', 'SIG04', 'SIG05');
commit;
...
DELETE
FROM loans
WHERE USER_ID IN ('USER001', 'USER002');
DELETE
FROM copies
WHERE SIGNATURE IN ('SIG01', 'SIG02');
DELETE
FROM editions
WHERE ISBN = 'ISBN123';
DELETE
